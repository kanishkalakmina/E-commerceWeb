...
return (
  <div>
      <div className='mx-auto px-4 py-16 bg-gray-800 text-black text-center w-full h-[100vh]'>
      <div>
          <h1 class="mb-20 mt-10 text-3xl font-extrabold text-gray-900 dark:text-white md:text-5xl lg:text-5xl"><span class="text-transparent bg-clip-text bg-gradient-to-r to-gray-600 from-gray-500">CREATE PRODUCTS</span> </h1>
      </div>
