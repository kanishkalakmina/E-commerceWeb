    ...
    <div className=''>
        ...
        <div className='w-full h-[70px] bg-gradient-to-r from-yellow-500  to-green-800  fixed'>
            <div className='max-w-[1240px] mx-auto px-4 flex justify-between items-center h-full'>
                <div>
                  <Link to='/'>
                <h1 class="mb-4 text-3xl  md:text-4xl lg:text-4xl"><span class="text-transparent bg-clip-text bg-gradient-to-r to-white from-white uppercase">𝔼-ℂ𝕃𝕆𝕋ℍ𝕀ℕ𝔾</span> </h1>
                </Link>
                </div>
                <div className='hidden md:flex'>
                    <ul className='flex text-white items-center font-mono font-extrabold text-[18px]'>
                   
                        <li><Link to='posts'>USER_VIEW</Link></li>
                        <li><Link to='admin'>ADMIN_VIEW</Link></li>
                ...
                <div className= {nav ? 'w-full bg-black text-white absolute top-[90px] left-0 flex justify-center text-center' : 'absolute left-[-100%]'}>
                    <ul>
                        <li className='text-1xl'><Link to='user'>USER_VIEW</Link></li>
                        <li className='text-1xl'><Link to='admin'>ADMIN_VIEW</Link></li>
